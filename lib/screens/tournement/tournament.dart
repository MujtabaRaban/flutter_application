...
import '../../blocs/tournements_bloc/tournement_event.dart';
import '../../blocs/tournements_bloc/tournement_state.dart';
...
class TournementPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return BlocProvider<TournamentPageBloc>(
      create: (context) => TournamentPageBloc()..add(LoadTournamentDataEvent()),
      child: _TournementPageContent(),
    );
  }
}

class _TournementPageContent extends StatefulWidget {
  @override
  _TournementPageState createState() => _TournementPageState();
}

class _TournementPageState extends State<_TournementPageContent> {
  late final TournamentPageBloc _tournamentPageBloc;

  @override
  void initState() {
    super.initState();
    _tournamentPageBloc = BlocProvider.of<TournamentPageBloc>(context);
  }
  ...
  Widget _buildGridView(TournamentPageState state) {
    if (state is LoadedTournamentDataState) {
    ...
    } else if (state is LoadingTournamentDataState) {
      return Center(
        child: CircularProgressIndicator(),
      );
    } else if (state is ErrorTournamentDataState) {
      return Center(
        child: Text(
          state.errorMessage,
